      ...
      <div className="pt-14 md:pt-16 bg-black max-h-auto">
        <div className="bg-black text-white min-h-screen flex flex-col justify-center items-center px-4 text-center">
          <h1 className="text-4xl md:text-6xl pt-12 font-bold mb-4">
            ...
            <br />
            <span className="text-gray-300 font-medium text-2xl md:text-3xl">
          ...
          <div className="flex gap-4">
            <button className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-full text-sm md:text-base shadow-lg transition">
              Learn more
            </button>
            <button className="border border-blue-400 text-blue-400 hover:bg-blue-800 hover:text-white px-6 py-2 rounded-full text-sm md:text-base transition">
              Try Now
            </button>
          </div>
